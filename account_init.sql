CREATE DATABASE  IF NOT EXISTS `bankmsdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bankmsdb`;
...
--
-- Table structure for table `card_request_data`
--
...
--
-- Table structure for table `savings_goal_data`
--
...
--
-- Dumping data for table `savings_goal_data`
--
LOCK TABLES `savings_goal_data` WRITE;
...
--
-- Table structure for table `savings_transaction_data`
--
...
--
-- Dumping data for table `savings_transaction_data`
--
LOCK TABLES `savings_transaction_data` WRITE;
