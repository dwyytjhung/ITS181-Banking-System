...
public class MainDashboardController {
    ...
    private void buildSidebar() {
        ...
        if (currentUser.getRole() == User.Role.ADMIN) {
            ...
            sidebarMenu.getChildren().add(createMenuButton("Deposit", "deposit.fxml", activeView));
            sidebarMenu.getChildren().add(createMenuButton("Withdraw", "withdraw.fxml", activeView));
            sidebarMenu.getChildren().add(createMenuButton("Transfer Money", "transfer.fxml", activeView));
            sidebarMenu.getChildren().add(createMenuButton("Savings Vault", "savings_goals.fxml", activeView));
